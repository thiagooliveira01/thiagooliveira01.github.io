...
var CadastroComponent = /** @class */ (function () {
    function CadastroComponent(authService, formBuilder) {
    ...
    CadastroComponent.prototype.cadastrar = function () {
        var _this = this;
        this.authService.cadastrarForm(this.form.value).subscribe(function (response) {
            ...
            _this.serverErrorMessages = error.ModelState.erro;
            toastr__WEBPACK_IMPORTED_MODULE_3___default.a.error('Ocorreu um erro ao processar a sua solicitação!');
        });
    };
    CadastroComponent.prototype.validacaoExtra = function (form) {
        //Confirmação
    ...
    CadastroComponent.prototype.setupForm = function () {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.authService.loginForm(this.form.value).subscribe(function (response) {
            _this.authService.setUser(response);
        }, function (error) {
            _this.serverErrorMessages = [error.error_description];
            toastr__WEBPACK_IMPORTED_MODULE_3___default.a.error('Ocorreu um erro ao processar a sua solicitação!');
        });
    };
