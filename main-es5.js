...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.loginForm = function (data) {
        var login = "grant_type=password&username=" + data.username + "&password=" + data.password;
        return this.http
    ...
    AuthService.prototype.cadastrarForm = function (data) {
        var httpOp = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    AuthService.prototype.setUser = function (resp) {
